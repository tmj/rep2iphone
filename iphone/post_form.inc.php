...
<input id="FROM" name="FROM" type="text" value="{$hd['FROM']}"{$name_size_at}>{$htm['k_br']} 
    </div>
    <div class="row">
    <label>E-mail</label> <input id="mail" name="mail" type="text" value="{$hd['mail']}"{$mail_size_at}{$on_check_sage}>
    </div>
{$sage_cb_ht}
